...
const IntakeMonitor = () => {
  ...
  return (
    <div className="bg-black text-white h-screen p-6 pr-0 flex gap-8 overflow-hidden">
      <div className="w-1/3 border-r border-gray-700 pr-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-row">
            ...
            <select
              ...
              className="select w-full bg-base-1000 p-2 rounded text-red placeholder-gray-400 focus:outline-none border border-gray-500"
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-row gap-4">
            ...
            />
            <button
              onClick={promptCalorie}
              className="btn mx-auto bg-[#FFB100] text-black px-4 py-2 rounded-lg font-semibold hover:bg-orange-400 transition-colors transform hover:scale-105 duration-500 shadow-lg text-sm"
              disabled={!foodname || !quantity || !unit}
            >
              GET CALORIES
            </button>
          </div>
        ...
        <button
          ...
          className="btn block mx-auto bg-[#FFB100] text-black px-4 py-2 rounded-full font-semibold hover:bg-orange-400 transition-colors transform hover:scale-105 duration-500 shadow-lg text-sm"
          disabled={!foodname || !quantity || !unit || !calories || !date}
        >
          ADD MEAL
        </button>
      </div>
